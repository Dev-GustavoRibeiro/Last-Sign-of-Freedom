...
const ESQUELETO_SCENE = preload("res://src/entities/enemy/thug.tscn")
const MOEDA_SCENE = preload("res://src/objects/collectibles/coin.tscn")
...
func _ready() -> void:
	...
	if player:
		var camera = player.get_node_or_null("player_camera")
